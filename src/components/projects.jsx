								...
								<div className="project" style={{backgroundImage: 'url(images/img-1.png)'}}>
									<div className="desc">
										<div className="con">
											...
											<p className="icon">
												<span><button href="#"><i className="icon-share3" /> </button></span>
												<span><button href="#"><i className="icon-eye" /> </button></span>
												<span><button href="#"><i className="icon-heart" /> </button></span>
											</p>
										</div>
									</div>
								</div>
